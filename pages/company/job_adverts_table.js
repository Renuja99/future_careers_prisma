    ...
    return (
      <div  className="flex flex-col rounded-lg bg-gray-300">
        <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full bg-slate-800 rounded-3xl sm:px-6 lg:px-8">
                  ...
                  {parsed.map(( parse , index) => (
                    <tr key={index}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="flex items-center">
                          <div className="flex items-center justify-center flex-shrink-0 h-10 w-10 rounded-full" style={{ backgroundColor: `${getRandomColor()}`}}>
                            ...
                            <h1 className="text-white text-2xl font-normal">{parse.job_title.charAt(0)}</h1>
                            
                          </div>
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">{parse.job_title}</div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a type="button" className="text-indigo-600 hover:text-indigo-900" onClick={()=>handleRedirect(parse.id)}>
                          View applicants
                        </a>
                      </td>
                    </tr>
